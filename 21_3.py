...
def welcome():
    window = Tk()
    #tk1.iconbitmap('i21.ico')
    window.title("21")
    window.geometry("400x200")
    #tk1.configure(background="grey")

    #wl=ttk.Label(window, text='Welcome!').pack

    wl = ttk.Label(window, foreground='white', text='Welcome!', background='grey', justify=CENTER, width=10, anchor="center", font=("Arial", 20)).pack
    #wl.configure(tk1, foreground='black', text='Welcome!', background='grey', width=10, anchor="center", font=("Arial", 20)) 
    #wl.place(x=0,y=0)
    #wl['text']='Welcome!'
    #wl.pack(tk1)
    #wl.pack(side=TOP)
    ...
    #wl1 = ttk.Label()
    #wl1.configure(tk1, foreground=txt_color, background='grey', width=30, anchor="center", font=("Arial", 12)) 
    #wl1.place(x=60,y=575)
    #wl1['text']='Your name'

    #wl2 = ttk.Label()
    #wl2.configure(tk1, foreground=txt_color, background='grey', width=30, anchor="center", font=("Arial", 12)) 
    #wl2.place(x=60,y=575)
    #wl2['text']='Your password'
    #sleep(5)
...
open_button.pack(side=TOP, anchor="ne", expand=1)
